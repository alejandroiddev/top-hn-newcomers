...
public class HackerNewsService {
    ...
    public List<Long> getNewStories() {
        ...
        return Arrays.asList(restTemplate.getForObject(NEW_STORIES_URL, Long[].class));
    }

    public Story findStory(Long id) {
        RestTemplate restTemplate = new RestTemplate();
        return restTemplate.getForObject(ITEM_RETRIEVER.replace("id", id.toString()), Story.class);
    }
